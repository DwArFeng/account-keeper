...
public class AccountCacheImpl implements AccountCache {
    ...
    private final RedisBatchBaseCache<StringIdKey, Account, FastJsonAccount> delegate;

    public AccountCacheImpl(RedisBatchBaseCache<StringIdKey, Account, FastJsonAccount> delegate) {
    ...
    @SkipRecord
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public List<Account> batchGet(@SkipRecord List<StringIdKey> keys) throws CacheException {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", rollbackFor = Exception.class)
    public void batchPush(@SkipRecord List<Account> entities, long timeout) throws CacheException {
