...
public class AccountDaoImpl implements AccountDao {
    ...
    private final BatchBaseDao<StringIdKey, Account> batchBaseDao;
    private final EntireLookupDao<Account> entireLookupDao;
    private final PresetLookupDao<Account> presetLookupDao;

    public AccountDaoImpl(
            BatchBaseDao<StringIdKey, Account> batchBaseDao,
            EntireLookupDao<Account> entireLookupDao,
            PresetLookupDao<Account> presetLookupDao
    ) {
