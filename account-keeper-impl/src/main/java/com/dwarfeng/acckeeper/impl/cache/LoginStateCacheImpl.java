...
public class LoginStateCacheImpl implements LoginStateCache {
    ...
    private final BatchBaseCache<StringIdKey, LoginState> batchBaseCache;

    public LoginStateCacheImpl(BatchBaseCache<StringIdKey, LoginState> batchBaseCache) {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", rollbackFor = Exception.class)
    public void batchPush(@SkipRecord List<LoginState> entities, long timeout) throws CacheException {
