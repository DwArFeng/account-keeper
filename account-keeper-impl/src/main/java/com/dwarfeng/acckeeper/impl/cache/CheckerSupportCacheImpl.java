...
import com.dwarfeng.acckeeper.sdk.bean.entity.FastJsonCheckerSupport;
import com.dwarfeng.acckeeper.stack.bean.entity.CheckerSupport;
import com.dwarfeng.acckeeper.stack.cache.CheckerSupportCache;
...
public class CheckerSupportCacheImpl implements CheckerSupportCache {
    ...
    private final RedisBatchBaseCache<StringIdKey, CheckerSupport, FastJsonCheckerSupport> batchBaseCache;

    public CheckerSupportCacheImpl(
            RedisBatchBaseCache<StringIdKey, CheckerSupport, FastJsonCheckerSupport> batchBaseCache
    ) {
