...
@Table(name = "tbl_protector_support")
public class HibernateProtectorSupport implements Bean {

    private static final long serialVersionUID = 2595191499056279893L;
    ...
    public HibernateProtectorSupport() {
    }
