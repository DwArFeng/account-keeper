...
@Table(name = "tbl_protect_detail_record")
public class HibernateProtectDetailRecord implements Bean {

    private static final long serialVersionUID = -6627261733708340858L;
    ...
    public HibernateProtectDetailRecord() {
    }
