...
public class DeriveHistoryMaintainServiceImpl implements DeriveHistoryMaintainService {
    ...
    @SkipRecord
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public PagedData<DeriveHistory> lookup(String preset, Object[] objs, PagingInfo pagingInfo)
    ...
    @SkipRecord
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public List<DeriveHistory> lookupAsList(String preset, Object[] objs, PagingInfo pagingInfo)
            throws ServiceException {
