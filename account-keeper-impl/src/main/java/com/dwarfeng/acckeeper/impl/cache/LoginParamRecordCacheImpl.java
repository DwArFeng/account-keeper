...
public class LoginParamRecordCacheImpl implements LoginParamRecordCache {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public LoginParamRecord get(RecordKey key) throws CacheException {
    ...
    public void push(LoginParamRecord value, long timeout) throws CacheException {
    ...
    @SkipRecord
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public List<LoginParamRecord> batchGet(@SkipRecord List<RecordKey> keys) throws CacheException {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", rollbackFor = Exception.class)
    public void batchPush(@SkipRecord List<LoginParamRecord> entities, long timeout) throws CacheException {
