...
public class ResetCommand extends CliCommand {
    ...
    private static final String COMMAND_OPTION_RESET_PROTECT = "reset-protect";
    ...
    private static final String CMD_LINE_SYNTAX_RESET_PROTECT = IDENTITY + " " +
            CommandUtil.concatOptionPrefix(COMMAND_OPTION_RESET_PROTECT);
    ...
    protected List<Option> buildOptions() {
        ...
        list.add(Option.builder().longOpt(COMMAND_OPTION_RESET_PROTECT).desc("执行保护重置操作").build());
        return list;
    }
        ...
        try {
            ...
            switch (pair.getLeft()) {
                ...
                case COMMAND_OPTION_STATUS:
                    printStatus(context);
                    break;
                case COMMAND_OPTION_RESET_PROTECT:
                    resetQosService.resetProtect();
