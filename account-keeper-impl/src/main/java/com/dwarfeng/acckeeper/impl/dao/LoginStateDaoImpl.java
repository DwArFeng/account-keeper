...
public class LoginStateDaoImpl implements LoginStateDao {
    ...
    private final RedisBatchBaseDao<LongIdKey, LoginState, FastJsonLoginState> batchBaseDao;
    private final RedisEntireLookupDao<LongIdKey, LoginState, FastJsonLoginState> entireLookupDao;
    private final RedisPresetLookupDao<LongIdKey, LoginState, FastJsonLoginState> presetLookupDao;

    public LoginStateDaoImpl(
            RedisBatchBaseDao<LongIdKey, LoginState, FastJsonLoginState> batchBaseDao,
            RedisEntireLookupDao<LongIdKey, LoginState, FastJsonLoginState> entireLookupDao,
            RedisPresetLookupDao<LongIdKey, LoginState, FastJsonLoginState> presetLookupDao
    ) {
