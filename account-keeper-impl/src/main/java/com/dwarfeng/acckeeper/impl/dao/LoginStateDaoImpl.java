...
public class LoginStateDaoImpl implements LoginStateDao {
    ...
    private final HibernateBatchBaseDao<StringIdKey, HibernateStringIdKey, LoginState, HibernateLoginState> batchDelegate;
    ...
    public LoginStateDaoImpl(
            HibernateBatchBaseDao<StringIdKey, HibernateStringIdKey, LoginState, HibernateLoginState> batchDelegate,
