...
public class LoginStateDaoImpl implements LoginStateDao {
    ...
    private final BatchBaseDao<StringIdKey, LoginState> batchBaseDao;
    private final EntireLookupDao<LoginState> entireLookupDao;
    private final PresetLookupDao<LoginState> presetLookupDao;

    public LoginStateDaoImpl(
            BatchBaseDao<StringIdKey, LoginState> batchBaseDao,
            EntireLookupDao<LoginState> entireLookupDao,
            PresetLookupDao<LoginState> presetLookupDao
    ) {
    ...
    public StringIdKey insert(LoginState element) throws DaoException {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public LoginState get(StringIdKey key) throws DaoException {
    ...
    @SkipRecord
    @Transactional(transactionManager = "hibernateTransactionManager", rollbackFor = Exception.class)
    public List<StringIdKey> batchInsert(@SkipRecord List<LoginState> elements) throws DaoException {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", rollbackFor = Exception.class)
    public void batchUpdate(@SkipRecord List<LoginState> elements) throws DaoException {
    ...
    @SkipRecord
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public List<LoginState> batchGet(@SkipRecord List<StringIdKey> keys) throws DaoException {
