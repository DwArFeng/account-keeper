...
public class LoginParamRecordDaoImpl implements LoginParamRecordDao {
    ...
    public RecordKey insert(LoginParamRecord element) throws DaoException {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", rollbackFor = Exception.class)
    public void update(LoginParamRecord element) throws DaoException {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public LoginParamRecord get(RecordKey key) throws DaoException {
    ...
    @SkipRecord
    @Transactional(transactionManager = "hibernateTransactionManager", rollbackFor = Exception.class)
    public List<RecordKey> batchInsert(@SkipRecord List<LoginParamRecord> elements) throws DaoException {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", rollbackFor = Exception.class)
    public void batchUpdate(@SkipRecord List<LoginParamRecord> elements) throws DaoException {
    ...
    @SkipRecord
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public List<LoginParamRecord> batchGet(@SkipRecord List<RecordKey> keys) throws DaoException {
    ...
    @SkipRecord
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public List<LoginParamRecord> lookup() throws DaoException {
    ...
    @SkipRecord
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public List<LoginParamRecord> lookup(PagingInfo pagingInfo) throws DaoException {
    ...
    @SkipRecord
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public List<LoginParamRecord> lookup(String preset, Object[] objs) throws DaoException {
    ...
    @SkipRecord
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public List<LoginParamRecord> lookup(String preset, Object[] objs, PagingInfo pagingInfo) throws DaoException {
