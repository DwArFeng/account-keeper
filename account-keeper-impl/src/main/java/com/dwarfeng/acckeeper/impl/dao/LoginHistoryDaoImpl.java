...
public class LoginHistoryDaoImpl implements LoginHistoryDao {
    ...
    private final BatchBaseDao<LongIdKey, LoginHistory> batchBaseDao;
    private final EntireLookupDao<LoginHistory> entireLookupDao;
    private final PresetLookupDao<LoginHistory> presetLookupDao;

    public LoginHistoryDaoImpl(
            BatchBaseDao<LongIdKey, LoginHistory> batchBaseDao,
            EntireLookupDao<LoginHistory> entireLookupDao,
            PresetLookupDao<LoginHistory> presetLookupDao
    ) {
    ...
    @SkipRecord
    @Transactional(transactionManager = "hibernateTransactionManager", rollbackFor = Exception.class)
    public List<LongIdKey> batchInsert(@SkipRecord List<LoginHistory> elements) throws DaoException {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", rollbackFor = Exception.class)
    public void batchUpdate(@SkipRecord List<LoginHistory> elements) throws DaoException {
    ...
    @SkipRecord
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public List<LoginHistory> batchGet(@SkipRecord List<LongIdKey> keys) throws DaoException {
