...
public class DeriveHistoryDaoImpl implements DeriveHistoryDao {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", rollbackFor = Exception.class)
    public List<LongIdKey> batchInsert(List<DeriveHistory> elements) throws DaoException {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", rollbackFor = Exception.class)
    public void batchUpdate(List<DeriveHistory> elements) throws DaoException {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public List<DeriveHistory> batchGet(List<LongIdKey> keys) throws DaoException {
