...
public class ProtectDetailRecordMaintainServiceImpl implements ProtectDetailRecordMaintainService {
    ...
    private final BatchCrudService<RecordKey, ProtectDetailRecord> crudService;
    private final EntireLookupService<ProtectDetailRecord> entireLookupService;
    private final PresetLookupService<ProtectDetailRecord> presetLookupService;

    public ProtectDetailRecordMaintainServiceImpl(
            BatchCrudService<RecordKey, ProtectDetailRecord> crudService,
            EntireLookupService<ProtectDetailRecord> entireLookupService,
            PresetLookupService<ProtectDetailRecord> presetLookupService
    ) {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public ProtectDetailRecord lookupFirst() throws ServiceException {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public ProtectDetailRecord lookupFirst(String preset, Object[] objs) throws ServiceException {
