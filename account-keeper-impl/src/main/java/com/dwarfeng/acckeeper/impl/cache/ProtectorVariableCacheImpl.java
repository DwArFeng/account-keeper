...
public class ProtectorVariableCacheImpl implements ProtectorVariableCache {
    ...
    private final BatchBaseCache<ProtectorVariableKey, ProtectorVariable> batchBaseCache;

    public ProtectorVariableCacheImpl(BatchBaseCache<ProtectorVariableKey, ProtectorVariable> batchBaseCache) {
