...
@Component
public class ProtectorSupportPresetCriteriaMaker implements PresetCriteriaMaker {

    @Override
    public void makeCriteria(DetachedCriteria detachedCriteria, String s, Object[] objects) {
        switch (s) {
            case ProtectorSupportMaintainService.ID_LIKE:
                idLike(detachedCriteria, objects);
                break;
            case ProtectorSupportMaintainService.LABEL_LIKE:
