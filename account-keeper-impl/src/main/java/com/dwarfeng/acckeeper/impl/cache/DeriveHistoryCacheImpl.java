...
public class DeriveHistoryCacheImpl implements DeriveHistoryCache {
    ...
    private final BatchBaseCache<LongIdKey, DeriveHistory> batchBaseCache;

    public DeriveHistoryCacheImpl(BatchBaseCache<LongIdKey, DeriveHistory> batchBaseCache) {
    ...
    @SkipRecord
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public List<DeriveHistory> batchGet(@SkipRecord List<LongIdKey> keys) throws CacheException {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", rollbackFor = Exception.class)
    public void batchPush(@SkipRecord List<DeriveHistory> entities, long timeout) throws CacheException {
