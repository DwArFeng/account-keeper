...
public class LoginHistoryMaintainServiceImpl implements LoginHistoryMaintainService {
    ...
    @SkipRecord
    @Transactional(transactionManager = "hibernateTransactionManager", rollbackFor = Exception.class)
    public List<LongIdKey> batchInsertIfNotExists(@SkipRecord List<LoginHistory> entities) throws ServiceException {
    ...
    @SkipRecord
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public List<LoginHistory> lookupAsList(String preset, Object[] objs, PagingInfo pagingInfo)
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public LoginHistory lookupFirst() throws ServiceException {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public LoginHistory lookupFirst(String preset, Object[] objs) throws ServiceException {
