...
import com.dwarfeng.acckeeper.stack.handler.ResetHandler;
import com.dwarfeng.acckeeper.stack.handler.Resetter;
import com.dwarfeng.acckeeper.stack.handler.ResetterHandler;
...
public class ResetQosServiceImpl implements ResetQosService {
    ...
    public void resetProtect() throws ServiceException {
        try {
            resetHandler.resetProtect();
        } catch (Exception e) {
            throw ServiceExceptionHelper.logAndThrow("重置保护时发生异常", LogLevel.WARN, sem, e);
        }
    }
}
