...
public class DubboResetter extends AbstractResetter {
    ...
    @Value("${com.dwarfeng.acckeeper.dubbo.provider.group}")
    ...
    public interface DubboResetService extends Service {
        ...
        boolean resetProtect() throws ServiceException;
    }
    ...
    public class DubboResetServiceImpl implements DubboResetService {
        ...
        @Override
        public boolean resetProtect() throws ServiceException {
            try {
                LOGGER.info("接收到保护重置消息, 正在重置保护...");
