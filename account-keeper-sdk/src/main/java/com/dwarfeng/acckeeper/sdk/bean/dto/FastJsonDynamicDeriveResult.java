 ...
 * @since 2.0.0
 */
public class FastJsonDynamicDeriveResult implements Bean {

    private static final long serialVersionUID = 6382017258381450843L;

    public static FastJsonDynamicDeriveResult of(DynamicDeriveResult dynamicDeriveResult) {
        if (Objects.isNull(dynamicDeriveResult)) {
            return null;
        } else {
            return new FastJsonDynamicDeriveResult(
                    FastJsonStringIdKey.of(dynamicDeriveResult.getLoginStateKey()),
                    FastJsonStringIdKey.of(dynamicDeriveResult.getAccountKey()),
                    dynamicDeriveResult.getExpireDate(),
                    dynamicDeriveResult.getGeneratedDate(),
                    dynamicDeriveResult.getType(),
                    dynamicDeriveResult.getRemark()
            );
        }
    }
    ...
    public FastJsonDynamicDeriveResult() {
    }
    ...
    public String toString() {
        return "FastJsonDynamicDeriveResult{" +
